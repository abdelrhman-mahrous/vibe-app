...
import 'features/player/views/providers/sound_player_provider.dart';
import 'features/spash_gate/views/screens/app_gate_screen.dart';
...
class VibeApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (context) => SoundPlayerProvider(),
